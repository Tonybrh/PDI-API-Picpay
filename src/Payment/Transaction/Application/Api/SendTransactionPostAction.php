...
namespace App\Payment\Transaction\Application\Api;

use App\Payment\Transaction\Application\Service\CreateHandler;
...
readonly class SendTransactionPostAction
{
    ...
    {
        $this->createHandler->__invoke($transactionVO);

        return new JsonResponse("Transação realizada com sucesso!!", Response::HTTP_CREATED);
    }
}