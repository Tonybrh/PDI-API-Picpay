 ...
 */
final class Version20241009201916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE public."user" (nu_seq_user BIGINT NOT NULL, nu_seq_wallet INT DEFAULT NULL, nu_seq_user_type INT NOT NULL, ds_name VARCHAR(255) NOT NULL, co_cpf_cnpj VARCHAR(20) NOT NULL, co_email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(nu_seq_user))');
