 ...
 */
final class Version20241007201437 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX idx_723705d175731136 ON transaction (nu_seq_user_receiver)');
        $this->addSql('CREATE INDEX idx_723705d1285349c6 ON transaction (nu_seq_user_sender)');
        ...
        $this->addSql('ALTER TABLE wallet ADD CONSTRAINT fk_7c68921ff915b6b3 FOREIGN KEY (nu_seq_user) REFERENCES "user" (nu_seq_user) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT fk_723705d1285349c6 FOREIGN KEY (nu_seq_user_sender) REFERENCES "user" (nu_seq_user) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT fk_723705d175731136 FOREIGN KEY (nu_seq_user_receiver) REFERENCES "user" (nu_seq_user) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT fk_bf5476caf915b6b3 FOREIGN KEY (nu_seq_user) REFERENCES "user" (nu_seq_user) NOT DEFERRABLE INITIALLY IMMEDIATE');
